  ...
  // password look and hide function
  $(document).ready(function () {
      $('.lookHidepassword .show-password').click(function () {
          let parent = $(this).closest('.authinput_feild');
          let input = parent.find('input');

          input.attr('type', 'text'); // Show password
          $(this).hide();
          parent.find('.hide-password').show();
      });

      $('.lookHidepassword .hide-password').click(function () {
          let parent = $(this).closest('.authinput_feild');
          let input = parent.find('input');

          input.attr('type', 'password'); // Hide password
          $(this).hide();
          parent.find('.show-password').show();
      });
  });
  ...
  document.querySelectorAll('.authinput_feild input').forEach(input => {
